...
bool is_small_hole(halfedge_descriptor h, Mesh& mesh, double max_hole_diam, int max_num_hole_edges)
{
...
MeshHolesFiller::MeshHolesFiller(std::string inputFile, std::string saveFile)
{
	...
	std::cout << "Mesh written to: " << saveFile << std::endl;
	out.precision(17);
	out << mesh << std::endl;
