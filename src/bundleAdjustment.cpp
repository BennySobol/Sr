...
bundleAdjustment::bundleAdjustment(std::vector<pointInCloud>& pointCloud, pcl::PointCloud<pcl::PointXYZRGB>& pclPointCloud)
{
	...
	_intrinsics[0] = cameraMatrix.at<double>(0, 0); //fx
	_intrinsics[1] = cameraMatrix.at<double>(1, 1); //fy
	_intrinsics[2] = cameraMatrix.at<double>(0, 2); //cx
	_intrinsics[3] = cameraMatrix.at<double>(1, 2); //cy
	...
	cameraMatrix.at<double>(0, 0) = _intrinsics[0]; //fx
	cameraMatrix.at<double>(1, 1) = _intrinsics[1]; //fy
	cameraMatrix.at<double>(0, 2) = _intrinsics[2]; //cx
	cameraMatrix.at<double>(1, 2) = _intrinsics[3]; //cy
}
